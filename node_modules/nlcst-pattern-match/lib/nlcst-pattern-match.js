...
var PatternMatcher = /** @class */ (function () {
    ...
    PatternMatcher.prototype.matchCST = function (cst, patterns) {
        ...
        walk(cst, {
            enter: function (node) {
                if (nlcst_types_1.isSentence(node)) {
                    var results = matcher_1.match(node.children, patterns);
    ...
    PatternMatcher.prototype.tag = function (strings) {
        ...
        var createPlaceholder = function (result, value) {
            ...
            if (nlcst_types_1.isPunctuation(value)) {
                return new Array(length + 1).join(".");
            }
            else if (nlcst_types_1.isWhiteSpace(value)) {
                return new Array(length + 1).join(" ");
            }
            else {
        ...
        walk(AST, {
            enter: function (node, parent) {
                ...
                if (nlcst_types_1.isParagraph(node) || nlcst_types_1.isSentence(node)) {
                    return;
                }
                replaceHolders
